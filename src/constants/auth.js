...
export const VERIFY_AUTH_REQUEST = Symbol('auth/VERIFY_AUTH_REQUEST');
export const VERIFY_AUTH_SUCCESS = Symbol('auth/VERIFY_AUTH_SUCCESS');
export const VERIFY_AUTH_FAILURE = Symbol('auth/VERIFY_AUTH_FAILURE');

export const EDIT_PROFILE_REQUEST = Symbol('auth/EDIT_PROFILE_REQUEST');
export const EDIT_PROFILE_SUCCESS = Symbol('auth/EDIT_PROFILE_SUCCESS');
export const EDIT_PROFILE_FAILURE = Symbol('auth/EDIT_PROFILE_FAILURE');
